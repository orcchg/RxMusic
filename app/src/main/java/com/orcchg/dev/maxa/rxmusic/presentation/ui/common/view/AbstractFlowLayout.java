package com.orcchg.dev.maxa.rxmusic.presentation.ui.common.view;
...
public class AbstractFlowLayout extends ViewGroup {
    ...
    /* Listener */
    // --------------------------------------------------------------------------------------------
    protected OnClickListener mDotsViewClickListener = (view) -> onDotsViewClicked();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthAtMostSpec = MeasureSpec.makeMeasureSpec(width, MeasureSpec.AT_MOST);
